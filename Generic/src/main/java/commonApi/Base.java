...
public class Base {
    ...
    public void takeScreenShot()throws IOException {
        ...
        FileUtils.copyFile(file,new File("ScreenShot\\screenShots.png"));}
    ...
    public void validateByCSS(String locator, String valdidationPoint){
        WebElement element=driver.findElement(By.cssSelector(locator));

        if (element.isDisplayed()){
            System.out.println(valdidationPoint+" is validated");
        }
        else {
            System.out.println(valdidationPoint+" is not validated");
        }
